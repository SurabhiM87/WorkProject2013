 ...
 */
Ext.define('EDGAR.view.LiveSearchGridPanelModified', {
...
//        var fileGrid = filesViewPort.getComponent('gridFiles');
            ...
            },
            {
                ...
                listeners:{
                    click: function(){
                        ...
                        store.reload();
                        Ext.getCmp('fileGridPopup'+selectedProjectId).getComponent('filePanel'+selectedProjectId).getComponent(selectedProjectId).getComponent('gridFiles').getView().refresh();
                    }
                }
            },
            {
                ...
                width: 25,
                height: 26,
                style: 'border: solid 1px #6D91C7; margin-left: 10px',
                scale: 'medium',
                iconCls: 'icons',
    ...
    onTextFieldChange: function(field, newValue, oldValue, options) {
        ...
        var filesViewPort = Ext.getCmp('fileGridPopup'+selectedProjectId).getComponent('filePanel'+selectedProjectId).getComponent(selectedProjectId);
        var grid = filesViewPort.getComponent('gridFiles');
 ...
 * Created by surabhimendiratta on 11/26/13.
 */
